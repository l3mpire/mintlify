...
<Info title="Are you an AI agent ? Use the skill.md for common use cases." icon="robot">
  Read the [skill.md](/skill.md) to get structured workflows, authentication details, and best practices for interacting with the lemlist API.
</Info>
