...
description: 'Learn how to authenticate with the lemlist API.'
---
...
![Generating a new lemlist API key](/images/getting-started/authentication/generateLemlistAPIKey.gif)
