...
<Warning>
  Hey marketing team, this page needs a revamp, the content below is a template from mintlify. I left it here for you to see how to structure a guide; where it's located in the project; how to reference it in `docs.json`.
</Warning>
